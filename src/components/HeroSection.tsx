        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            >
              ...
              >
                <Button className="bg-black dark:bg-white text-white dark:text-black hover:bg-black dark:hover:bg-white px-8 py-6 text-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
                  <motion.div
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <Button variant="ghost" className="text-black dark:text-white px-8 py-6 text-lg flex items-center gap-2 hover:bg-white dark:hover:bg-black transition-all duration-300">
                  <motion.div
                ...
                <div className="p-8 min-h-[400px] bg-white dark:bg-black">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 text-black dark:text-white">
                      ...
                      ></motion.span>
                      <span className="text-sm">{t.writingInProgress}</span>
                    </div>
                    <motion.div 
